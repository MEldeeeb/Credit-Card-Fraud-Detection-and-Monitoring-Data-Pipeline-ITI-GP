...
with DAG(
    ...
    remove_duplicates_customer_dim = PythonOperator(
        ...
        op_kwargs={
            ...
            'query3': """ INSERT INTO customer_dim select distinct on (customer_id) customer_id, cc_num, first, last, gender, dob, age, job, street, city, state, zip, lat, long, city_pop FROM temp_table; """,
